...
export const initialPlanCycle: PlanWeek[] = [
  {
    ...
    days: {
      monday: {
        ...
        'mon-main-55': { weight: '55', sets: '5 x 4' },
      },
      wednesday: {
        'wed-warm-20': { weight: '20', sets: '1 x 15' },
        'wed-warm-35': { weight: '35', sets: '1 x 8' },
        'wed-warm-45': { weight: '45', sets: '1 x 5' },
        'wed-main-52-5': { weight: '52.5', sets: '5 x 3' },
      },
      friday: {
        'fri-warm-20': { weight: '20', sets: '1 x 15' },
        'fri-warm-40': { weight: '40', sets: '1 x 8' },
        'fri-warm-52-5': { weight: '52.5', sets: '1 x 5' },
        'fri-main-60': { weight: '60', sets: '2 x 2' },
      },
    },
  },
  {
    ...
    days: {
      monday: {
        'mon-warm-20': { weight: '20', sets: '1 x 15' },
        'mon-warm-40': { weight: '40', sets: '1 x 8' },
        'mon-warm-50': { weight: '52.5', sets: '1 x 5' },
        'mon-main-55': { weight: '60', sets: '4 x 3' },
      },
      wednesday: {
        'wed-warm-20': { weight: '20', sets: '1 x 15' },
        'wed-warm-35': { weight: '40', sets: '1 x 8' },
        'wed-warm-45': { weight: '50', sets: '1 x 5' },
        'wed-main-52-5': { weight: '55', sets: '4 x 2' },
      },
      friday: {
        'fri-warm-20': { weight: '20', sets: '1 x 15' },
        'fri-warm-40': { weight: '45', sets: '1 x 8' },
        'fri-warm-52-5': { weight: '55', sets: '1 x 5' },
        'fri-main-60': { weight: '62.5', sets: '2 x 1' },
      },
    },
  },
  {
    ...
    days: {
      monday: {
        'mon-warm-20': { weight: '20', sets: '1 x 15' },
        'mon-warm-40': { weight: '35', sets: '1 x 8' },
        'mon-warm-50': { weight: '42.5', sets: '1 x 5' },
        'mon-main-55': { weight: '50', sets: '3 x 3' },
      },
      wednesday: {
        'wed-warm-20': { weight: '20', sets: '1 x 15' },
        'wed-warm-35': { weight: '35', sets: '1 x 8' },
        'wed-warm-45': { weight: '45', sets: '1 x 5' },
        'wed-main-52-5': { weight: '55', sets: '3 x 3' },
      },
      friday: {
        'fri-warm-20': { weight: '20', sets: '1 x 15' },
        'fri-warm-40': { weight: '40', sets: '1 x 8' },
  ...
  },
  {
    ...
    days: {
      ...
      friday: {
        ...
        'fri-warm-40': { weight: '40', sets: '1 x 8' },
        'fri-warm-52-5': { weight: '55', sets: '1 x 5' },
        'fri-lead-60': { weight: '60', sets: '1 x 1' },
        'fri-lead-65': { weight: '65', sets: '1 x 1' },
        'fri-max-70': { weight: '70', sets: '1 x 1' },
        'fri-max-72-5': { weight: '72.5', sets: '1 x 1' },
        'fri-max-75': { weight: '75', sets: '1 x 1' },
      },
    },
  },
]
